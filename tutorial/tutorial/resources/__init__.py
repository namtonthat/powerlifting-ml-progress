...
class DataGenerator:
    ...
    def get_signups_for_dates(self, start_date: datetime, end_date: Union[datetime, None] = None) -> Sequence[Signup]:
        signups = []
...
class DataGeneratorResource(ConfigurableResource):
    ...
    num_days: int = Field(description="Number of days to generate data for. Defaults to 7", default=7)
